...
<html>
	<head>
		<title>STforU, 당신의 재능을 나누다.</title>
		<meta charset="utf-8" />
							...
							<section id="banner">
								<article data-position="bottom right">
									<div class="inner">
										...
										<h2 style= "font-family: 'Nanum Pen Script';">STforU는 당신을 기다립니다.</h2>
										<p style= "font-family: 'Nanum Pen Script'; font-size: 1.5em">여러분의 재능을 공유하고 나누세요. 서로의 인사이트를 공유하고 함께 성장해요. </p>
										<ul class="actions">
											<li><a class="button large" href="#" style= "font-family: 'Nanum Pen Script'; font-size: 1.5em">함께 재능 공유할 친구 찾기</a></li>
										</ul>
									</div>
								</article>
								<article data-position="top right">
									<div class="inner">
										...
										<h2 style= "font-family: 'Nanum Pen Script';">STforU는 성장을 목표로 합니다.</h2>
										<p style= "font-family: 'Nanum Pen Script'; font-size: 1.5em">서로 다른 분야를 함께 이야기하며 성장을 경험해보세요. 다름 속에서 발견하는 기쁨을 찾아요.</p>
										<ul class="actions">
											<li><a style= "font-family: 'Nanum Pen Script' ; font-size: 1.5em" class="button large" href="#" >나와 관심사 같은 친구 찾기</a></li>
										</ul>
									</div>
								</article>
								<article data-position="right">
									<div class="inner">
										...
										<h2 style= "font-family: 'Nanum Pen Script';">STforU는 당신의 재능이 궁금합니다.</h2>
										<p style= "font-family: 'Nanum Pen Script'; font-size: 1.5em">작은 것이라도 좋아요. 당신이 가지고 있는 재능을 공유하고, 당신을 기다리고 있는 많은 사람들을 통해 발전시키세요.</p>
										<ul class="actions">
											<li><a style= "font-family: 'Nanum Pen Script'; font-size: 1.5em;" class="button large" href="#">내 재능을 기다리고 있는 친구 찾기</a></li>
										</ul>
									</div>
								</article>
								<article data-position="center">
									<div class="inner">
										...
										<h2 style= "font-family: 'Nanum Pen Script';">STforU는 여러분과 함께합니다.</h2>
										<p style= "font-family: 'Nanum Pen Script'; font-size: 1.5em">
										여러분은 혼자가 아니에요. 마음껏 공유하고, 마음껏 성장하세요.
										</p>
										<ul class="actions">
											<li><a style= "font-family: 'Nanum Pen Script'; font-size: 1.5em" class="button large" href="#">내가 배우고 싶은 재능 찾기</a></li>
										</ul>
									</div>
								</article>
							</section>
